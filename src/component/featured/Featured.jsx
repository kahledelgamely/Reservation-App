...
function Featured() {
    return (
        <div className='items-container'>
            ...
            <div className="item">
                <img
                    src="https://cf.bstatic.com/xdata/images/city/max500/690334.webp?k=b99df435f06a15a1568ddd5f55d239507c0156985577681ab91274f917af6dbb&o=" alt="" />
                <div className="info">
                    <h1>hrtshdgh</h1>
                    <h2>123 pdostrhsdthsojsg</h2>
                </div>
            </div>
            <div className="item">
